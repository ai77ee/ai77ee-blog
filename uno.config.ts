...
export default defineConfig({
  ...
  theme: {
    ...
    fontFamily: {
      title: ['Special Elite', 'Luxurious Roman', 'EarlySummer-Subset', 'EarlySummer', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
      navbar: ['STIX-Italic', 'EarlySummer-Subset', 'EarlySummer', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
      time: ['LXGW WenKai Mono TC', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
